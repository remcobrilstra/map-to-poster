...
export function setupControls() {
	...
	const applyFontPreview = (select) => {
		if (select) select.style.fontFamily = select.value;
	};

	if (cityFontSelect) {
		cityFontSelect.addEventListener('change', (e) => {
			applyFontPreview(e.target);
	...
	return (currentState) => {
		...
		if (cityFontSelect) { cityFontSelect.value = currentState.cityFont; applyFontPreview(cityFontSelect); }
		if (countryFontSelect) { countryFontSelect.value = currentState.countryFont; applyFontPreview(countryFontSelect); }
		if (coordsFontSelect) { coordsFontSelect.value = currentState.coordsFont; applyFontPreview(coordsFontSelect); }
