export const artisticThemes = {
	blueprint: {
		name: "Blueprint",
		description: "Deep navy drafting board with crisp broken-white linework",
		bg: "#1A3A5C",
		text: "#F8F4ED",
		water: "#0F2540",
		parks: "#1E4268",
		...
		road_primary: "#F0EBE0",
		road_secondary: "#D4CCBF",
		road_tertiary: "#ADA69C",
		road_residential: "#5C7080",
		road_default: "#8C8278",
		route: "#FFD700"
	},
	creme: {
		name: "Crème",
		description: "Warm parchment ground with muted ink tones for a timeless print",
		bg: "#F5EDDB",
		text: "#3D2B1A",
		water: "#D4C4A8",
		parks: "#E2D8C6",
		road_motorway: "#7A5C3E",
		road_primary: "#9B7B5A",
		road_secondary: "#B89A7A",
		road_tertiary: "#C8B090",
		road_residential: "#D8CAAF",
		road_default: "#B89A7A",
		route: "#A0291E"
	},
	misty_topo: {
		name: "Misty Topo",
		description: "Soft sage land, dusty slate water and warm grey roads - like a well-loved topo map",
		bg: "#CDD8C0",
		text: "#2D3A2E",
		water: "#8BB4C8",
		parks: "#B5C9A4",
		road_motorway: "#7A6E62",
		road_primary: "#9A8E82",
		road_secondary: "#B0A69C",
		road_tertiary: "#C4BCB4",
		road_residential: "#D8D4CE",
		road_default: "#B0A69C",
		route: "#C04A2A"
	},
	ancient_woodland: {
